...
{
    public function calculateProjectedReleaseDate(CarbonImmutable $sentenceStartDate, int $years, int $months = 0): CarbonImmutable
    {
        $sentenceEndDate = $sentenceStartDate->addYears($years)->addMonths($months);
