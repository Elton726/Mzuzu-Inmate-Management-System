...
export default function SessionFormModal({ open, onClose, onSave, defaultValues = {} }) {
      ...
      <form onSubmit={handleSubmit(onSave)} className="space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div>
            ...
            />
            {inmateQuery && (
              <div className="mt-2 rounded border border-gray-200 bg-white shadow-sm max-h-52 overflow-auto dark:bg-slate-900 dark:border-slate-700">
                {isSearchingInmate ? (
                  ...
                  inmateOptions.map((inmate) => (
                    <button
                      ...
                      className="w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-slate-800"
                    >
